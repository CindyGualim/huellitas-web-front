...
function HeroCarousel({ slides }: { slides: HeroSlideView[] }) {
  ...
  return (
    <div className="relative w-full h-[320px] md:h-[440px] overflow-hidden rounded-[24px]">
      ...
      <div
        className="absolute inset-0 z-20 flex flex-col justify-end px-5 md:px-10 pb-7 md:pb-10 transition-opacity duration-300"
                  ...
                  return (
                    <div key={pet.id} className="bg-white rounded-2xl overflow-hidden border border-[#D9D9D9]/60 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
                      ...
                      <div className="p-4 flex-1 flex flex-col">
                        <h3 className="text-base font-bold text-[#222222] mb-1">{pet.name}</h3>
